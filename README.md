...
Using a pre-trained YOLOv8 model (yolov8n.pt)

Detecting and tracking vehicles in a video

Drawing a reference line to estimate speed
...
The displayed speeds are approximate (estimated).
